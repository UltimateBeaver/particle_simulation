...
TARGETS = serial serial_linear openmp openmp_linear autograder mpi mpi_fast mpi_aggressive mpi_final 
...
mpi_final: mpi_final.o common.o
	$(MPCC) -o $@ $(LIBS) $(MPILIBS) mpi_final.o common.o
...
mpi_final.o: mpi_final.cpp common.h
	$(MPCC) -c $(CFLAGS) mpi_final.cpp
